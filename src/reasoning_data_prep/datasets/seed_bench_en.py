...
def build_seed_bench_en_reasoning_request(
    ...
    user_message_lines = [
        ...
        "Верни question_ru: естественный перевод исходного вопроса на русский язык вместе с вариантами ответа, текст вариантов ответа тоже должны быть на русском.",
        ...
        "Не упоминай, что правильный ответ был дан заранее и не допускай утечки информации из ответа в сформированный вопрос.",
        "",
    ...
    if answer_mode == "letter_only":
        ...
        user_message_lines.insert(
            7,
            "Верни answer_ru в том формате в которм он дан, буква ответа и текст правильного варианта, но на русском.",
        )
